...
Some introductory things in automated ways to improve your code.
...
- ReStructuredText into nice documentation.
...
Gives a quick look at the status of your project.
  - is tested, well covered etc.

You can make your own badges at [shields.io/](https://shields.io/).


### Advanced for dev teams / large projects:
- [pre-commit Hooks](https://github.com/pre-commit/pre-commit-hooks)
    - Lint check, run tests have to pass before commits.
...
### Advice
Blogs are a good source of examples. test-and-code
Project docs.
